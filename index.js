...
function addArtist(array) {
  array.push({
    id: 20,
    name: "David",
    years: "07/12/2002 - 1/13/2022",
    genre: "Web Design",
    nationality: "russian",
    bio: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Porta non pulvinar neque laoreet suspendisse interdum consectetur libero id."
  })
  return array
}
...
function artistByCountry(array, type){
  let s = [];
  for (let i = 0; i < array.length; i++) {
    if (array[i].nationality === type) {
      s.push(array[i].name)
    }
  }
  return s
